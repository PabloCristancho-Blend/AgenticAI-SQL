...
# def generar_query(pregunta: str) -> str:
#     """
#     Traduce una pregunta en lenguaje natural a una consulta SQL simple.
#     En producción, aquí puedes integrar un modelo de lenguaje (ej. OpenAI o MCP tool).
#     """
#     pregunta = pregunta.lower()

#     if "todas" in pregunta or "ventas" in pregunta:
#         return "SELECT * FROM ventas;"
#     elif "cliente" in pregunta:
#         return "SELECT DISTINCT cliente FROM ventas;"
#     elif "total" in pregunta:
#         return "SELECT SUM(total) AS total_general FROM ventas;"
#     elif "fecha" in pregunta or "octubre" in pregunta:
#         return "SELECT * FROM ventas WHERE fecha LIKE '%2024-10%';"
#     else:
#         return "SELECT * FROM ventas LIMIT 5;"

@mcp.tool()
def consultar_ventas_mes(mes: str) -> str:
...
@mcp.tool()
def consultar_ventas_ciudad(sede: str) -> str:
    """Devuelve el resultado de una consulta generada automáticamente a partir de una pregunta natural."""
...
@mcp.tool()
def get_ventas_vendedores(vendedor: str) -> str:
    """Devuelve el resultado de una consulta generada automáticamente a partir de una pregunta natural."""
